...
export function homeSpiceRack() {
    return array2Obj([ControlPubDictionary["MQTT_SPICE_CTRL"], SpicePubDictionary["SPICE_STAT_HOMERACK"]])
}

export function moveSpiceRack2Position(position) {
    return array2Obj([ControlPubDictionary["MQTT_SPICE_CTRL"], SpicePubDictionary["SPICE_STAT_INDEX"], position])
}
...
export function dispenseOil(volume) {
    return array2Obj([ControlPubDictionary["MQTT_OILWAT_CTRL"], LiquidStationPubDictionary["OILWAT_STAT_DISPOIL"], volume])
}

export function dispenseWater(volume) {
    return array2Obj([ControlPubDictionary["MQTT_OILWAT_CTRL"], LiquidStationPubDictionary["OILWAT_STAT_DISPWAT"], volume])
}

export function switchOffRiceCooker() {
    return array2Obj([ControlPubDictionary["MQTT_RICE_CTRL"], InductionPubDictionary["LOOP_STAT_RICEON_STR"], "ON"])
}

export function switchOnRiceCooker() {
    return array2Obj([ControlPubDictionary["MQTT_RICE_CTRL"], InductionPubDictionary["LOOP_STAT_RICEON_STR"], "OFF"])
}

export function setRiceCookerTemperature(temperature) {
    return array2Obj([ControlPubDictionary["MQTT_RICE_CTRL"], InductionPubDictionary["LOOP_STAT_RICE_TEMP_STR"], temperature])
}
